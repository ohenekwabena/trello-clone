      ...
      <Card className="p-6">
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Team activity in the last 7 days</p>
          </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div>
            <div className="mb-4 flex items-center gap-2">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-white">Most Active</h4>
            </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400">{member.activityCount} activities</p>
                      </div>
                    </div>
                    <Badge variant={index === 0 ? "default" : "secondary"} className={index === 0 ? "bg-blue-600" : ""}>
                      #{index + 1}
                    </Badge>
                  </motion.div>
                ))}
          ...
          <div>
            <div className="mb-4 flex items-center gap-2">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-white">Recent Assignments</h4>
            </div>
              ...
              <div className="space-y-3">
                {data.recentAssignments.slice(0, 5).map((assignment, index) => (
                  <motion.div
                    ...
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.3, delay: index * 0.1 }}
                    className="group rounded-lg border p-3 transition-all hover:border-purple-500 hover:bg-purple-50 dark:border-gray-700 dark:hover:bg-purple-900/20"
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm">
                            <span className="font-semibold text-gray-900 dark:text-white">{assignment.actorName}</span>{" "}
